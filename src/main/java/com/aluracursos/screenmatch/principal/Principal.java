...
public class Principal {
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    7 - Mostrar Series según cantidad de temporadas y calificación. 
                    8 - Buscar episodios por título.
                    9 - Listar los 5 mejores episodios por serie.              
                    0 - Salir.
    ...
    private void buscarSeriesPorTitulo(){
        System.out.println("Ingrese el nombre de la serie que busca");
        var nombreSerie = teclado.nextLine();
    ...
    private void buscarSeriesPorCategoria(){
        System.out.println("Ingrese el genero o categoría de serie que desea buscar: ");
...
/*        List<Serie> filtroSeries = repositorio.seriesPorTemporadaYEvaluacion();*/
    ...
    private void buscarEpisodiosPorTitulo(){
        System.out.println("Ingrese el nombre del episodio que quiere buscar: ");
